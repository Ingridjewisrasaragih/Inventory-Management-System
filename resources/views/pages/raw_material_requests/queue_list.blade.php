...
@section('title', 'Raw Material Queue List')
  ...
  <div class="container-fluid">
    ...
    <div class="card shadow mb-4">
      <div class="card-header py-3">
        <h5 class="m-0 font-weight-bold text-primary">Raw Material Queue List</h5>
      </div>
      <div class="card-body">
                  ...
                  <td>
                    <div class="dropdown">
                      ...
                      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        @can('raw-req-confirm')
                          {{-- confirm --}}
                          <form action="{{ route('raw-material-requests.confirmation', $item->id) }}" method="post">
                            @method('put')
                            @csrf
